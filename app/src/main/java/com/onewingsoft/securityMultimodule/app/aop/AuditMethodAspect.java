package com.onewingsoft.securityMultimodule.app.aop;
...
class AuditMethodAspect {
    ...
    public Object auditMethod(ProceedingJoinPoint call) throws Throwable {
        ...
        // Method over which the annotation executes
        ...
        AuditMethod.Level[] level = annotation.level();
