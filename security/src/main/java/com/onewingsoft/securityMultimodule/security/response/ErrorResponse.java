package com.onewingsoft.securityMultimodule.security.response;

import java.io.Serializable;

/**
 * Response object for the rest service when an error has occurred. Normally, this response is used in the handler
 * {@link com.onewingsoft.securityMultimodule.security.handlers.JwtAuthenticationFailureHandler}.
 *
 * @author iiglesias
 */
