package com.onewingsoft.securityMultimodule.security.config;

import com.onewingsoft.securityMultimodule.security.filters.JwtTokenFilter;
import com.onewingsoft.securityMultimodule.security.providers.JwtLoginAuthenticationProvider;
...
@PropertySource(value = { "classpath:security.properties", "classpath:redis.properties" })
@ComponentScan(value = { "com.onewingsoft.securityMultimodule.security" })
